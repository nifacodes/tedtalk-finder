// Strings to call when changing state with reducer

// functions defined in App.js
export const SEARCH_TALK = 'SEARCH_TEDTALK';
...
export const SET_THUMBNAILS_BY_ID = 'SET_THUMBNAILS_BY_ID';
export const SET_EMPTY_RESULTS = 'SET_EMPTY_RESULTS';